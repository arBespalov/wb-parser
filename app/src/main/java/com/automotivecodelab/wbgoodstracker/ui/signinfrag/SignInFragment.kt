...
class SignInFragment : Fragment() {
    ...
    private val viewModel: SignInViewModel by viewModels { SignInViewModelFactory(getItemsRepository(), getUserRepository()) }
        ...
        viewDataBinding?.apply {
            ...
            signOutButton.apply {
                ...
                setOnClickListener {
                    ...
                    viewModel.signOut()
                    Toast.makeText(requireContext(), R.string.sign_out_message, Toast.LENGTH_LONG).show()
                }
            }
            signInButton.visibility = View.INVISIBLE
            swipeRefresh.isRefreshing = false
